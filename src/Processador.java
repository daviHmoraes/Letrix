...
public class Processador {
	...
	public void verificarPalpite(String tentativa, String palavraSecreta, ArrayList<String> letrasNaoUsadas) {

		if (tentativa.length() == 5) {

			for (int i = 0; i < tentativa.length(); i++) {

				letrasNaoUsadas.remove(String.valueOf(tentativa.charAt(i)));
